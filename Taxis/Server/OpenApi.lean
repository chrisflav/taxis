...
namespace Taxis.Server.OpenApi
...
def spec : Json := obj [
  ("openapi", str "3.0.3"),
  ("info", obj [("title", str "taxis API"), ("version", str "0.1.0"),
    ("description", str "REST API for taxis, the Lean issue tracker. All endpoints are served under `/api`.")]),
